...
public class Instantiation implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception 
    {
        ...
        Post post1 = new Post(null, LocalDate.parse("21/03/2025", fmt), "Partiu viagem", "Vou viajar para São Paulo, Abraços!", maria);
        Post post2 = new Post(null, LocalDate.parse("23/03/2025", fmt), "Bom dia", "Acordei feliz hoje!", maria);
